...
describe("Overlay", () => {
  ...
  it("renders training warning and keeps realtime advice disabled by default", () => {
    ...
    expect(document.querySelector(".mh-title").textContent).toContain("v0.2.12");
  ...
  it("upgrades stored low capture config on mount", () => {
    ...
    expect(document.querySelector('[data-role="install-diagnostics"]').textContent).toContain("v0.2.12");
