...
- Goal: collect/import a safe `0.2.11` real-page capture from round start and use it as the main verification artifact.
...
- Status: Partially improved in `0.2.11`; unknown starting hands no longer get synthesized from own draw/discard traffic.
