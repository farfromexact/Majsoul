...
2. Confirm the `Majsoul Helper v0.2.3` overlay appears. If the title does not show `v0.2.3`, Tampermonkey is still running an older generated userscript.
